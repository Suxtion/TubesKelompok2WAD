...
@section('title', 'Tambah Menu Catering')

@section('content')
<div class="card">
    <div class="card-header">
        <h5 class="mb-0">Tambah Menu Catering - {{ $vendor->name }}</h5>
    </div>
    <div class="card-body">
        <form action="{{ route('admin.catering-vendors.menus.store', $vendor->id) }}" method="POST">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="price_per_pax" name="price_per_pax" min="0" required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="delivery_time_estimate" name="delivery_time_estimate" min="1" required>
            </div>
